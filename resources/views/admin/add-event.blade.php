  ...
  <div class="bg-white w-full max-w-md p-5 rounded mx-auto">
    ...
    <form method="post" action="/dashboard/events">
      ...
      <div class="mb-6">
        ...
        <input type="time" id="waktu" name="waktu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-none focus:border-blue-500 block w-full p-2.5" value="{{ old('waktu') }}">
        @error('waktu')
          <div class="text-sm text-red-500">{{ $message }}</div>
        @enderror
      </div>
